...
public class SelectionController extends LabeledFieldController {
    ...
    public SelectionController(Context ctx, String name, String labelText, boolean isRequired, String prompt, List<String> items, boolean useItemsAsValues) {
        this(ctx, name, labelText, isRequired, prompt, items, useItemsAsValues ? items : null, 0);
    }
     ...
     */
    public SelectionController(Context ctx, String name, String labelText, boolean isRequired, String prompt, List<String> items, List<?> values, int defaultIndex) {
    ...
    protected View createFieldView() {
        ...
        spinnerView.setSelection(this.defaultIndex);
